...
//        public Empregado(int idade, string nome, int nif, int num) : base(idade, nome, nif)
//        {
//            numeroCliente = num;
//        }
...
//        {
//            Empregado aux = (Empregado)obj;
//            return (this.numeroCliente == aux.numeroCliente ? true : false);
//        }
//        #endregion
//        #region OPER
//        public static bool operator ==(Empregado x, Empregado y)
//        {
//            return (x.Equals(y));
//        }
